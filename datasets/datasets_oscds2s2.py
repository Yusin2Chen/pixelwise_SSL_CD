...
class OSCD_S2(data.Dataset):
    ...
    def __init__(self,
        ...
        if subset == "train":
            train_list = []
            #for seasonfolder in ['abudhabi', 'beihai', 'beirut', 'bordeaux',
            #                     'chongqing', 'cupertino', 'dubai', 'hongkong', 'lasvegas', 'milano', 'montpellier',
            #                     'mumbai', 'nantes', 'pisa', 'rennes', 'saclaye',
            #                     'saclayw', 'valencia']:
            for seasonfolder in ['L15-0357E-1223', 'L15-0487E-1246', 'L15-0614E-0946', 'L15-1015E-1062', 'L15-1204E-1202', 'L15-1296E-1198', 'L15-1546E-1154', 'L15-1672E-1207', 'L15-1848E-0793',
'L15-0358E-1220', 'L15-0506E-1204', 'L15-0632E-0892', 'L15-1025E-1366', 'L15-1204E-1204', 'L15-1298E-1322', 'L15-1615E-1205', 'L15-1690E-1210',
'L15-0361E-1300', 'L15-0509E-1108', 'L15-0683E-1006', 'L15-1031E-1300', 'L15-1209E-1113', 'L15-1389E-1284', 'L15-1615E-1206', 'L15-1690E-1211',
'L15-0368E-1245', 'L15-0544E-1228', 'L15-0697E-0874', 'L15-1049E-1370', 'L15-1210E-1025', 'L15-1438E-1134', 'L15-1617E-1207', 'L15-1691E-1211',
'L15-0369E-1244', 'L15-0566E-1185', 'L15-0744E-0927', 'L15-1129E-0819', 'L15-1213E-1238', 'L15-1438E-1227', 'L15-1630E-0988', 'L15-1703E-1219',
'L15-0387E-1276', 'L15-0571E-1302', 'L15-0760E-0887', 'L15-1138E-1216', 'L15-1249E-1167', 'L15-1439E-1134', 'L15-1666E-1189', 'L15-1709E-1112',
'L15-0391E-1219', 'L15-0577E-1243', 'L15-0924E-1108', 'L15-1172E-1306', 'L15-1276E-1107', 'L15-1479E-1101', 'L15-1669E-1153', 'L15-1716E-1211',
'L15-0434E-1218', 'L15-0586E-1127', 'L15-0977E-1187', 'L15-1185E-0935', 'L15-1281E-1035', 'L15-1481E-1119', 'L15-1669E-1160', 'L15-1748E-1247',
'L15-0331E-1257', 'L15-0457E-1135', 'L15-0595E-1278', 'L15-1014E-1375', 'L15-1203E-1203', 'L15-1289E-1169', 'L15-1538E-1163', 'L15-1670E-1159', 'L15-1749E-1266',]:
        ...
        for folder in sample_dirs:
            ...
            if len(s2_locations) > 1:
                ...
                comb_list = [comb_list[i] for i in range(len(comb_list))
                             if ((int(os.path.basename(comb_list[i][0])[0:6]) - int(os.path.basename(comb_list[i][1])[0:6]))==-5)]
